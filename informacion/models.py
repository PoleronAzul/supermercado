...
class Persona(models.Model):
    Run = models.CharField(max_length=15,PrimaryKey=True,null=False,blank=False)
...
class Producto(models.Model):
    ...
    stock = models.AutoField(null=False,blank=False)
    precio = models.AutoField(null=False,blank=False)
